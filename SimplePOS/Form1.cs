...
namespace SimplePOS
{
    public partial class Form1 : Form
    {
        ...
        private void BuildTopBar()
        {
            ...
            // ── INVENTORY BUTTON (add inside BuildTopBar, before the closing brace) ──

            Button btnInventory = new Button();
            btnInventory.Text = "📦  Inventory";
            btnInventory.Font = new Font("Segoe UI", 9, FontStyle.Bold);
            btnInventory.ForeColor = Color.White;
            btnInventory.BackColor = Color.FromArgb(41, 121, 255);   // clrBlue
            btnInventory.FlatStyle = FlatStyle.Flat;
            btnInventory.FlatAppearance.BorderSize = 0;
            btnInventory.Size = new Size(128, 34);
            btnInventory.Cursor = Cursors.Hand;
            btnInventory.Click += (s, e) =>
            {
                var invForm = new InventoryForm(products);
                invForm.ShowDialog(this);
                // Refresh POS product panel after any inventory changes
                DisplayProducts();
                RefreshCart();
            };
            topBar.Controls.Add(btnInventory);
            topBar.Layout += (s, e) =>
                btnInventory.Location = new Point(topBar.Width - 350, 12);
